...
**Note**: This tool is designed for educational and decision-support purposes only and should not replace professional medical advice.
...
**IMPORTANT**: This application is for **educational and research purposes only**. It is not intended to:
- Replace professional medical diagnosis
- Provide medical advice
- Be used as a sole basis for treatment decisions

Always consult with qualified healthcare professionals for medical diagnosis and treatment. The predictions generated by this tool are estimates based on machine learning models and should be interpreted with caution.
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Janvi043/Heart-Disease-Predictor/issues).
